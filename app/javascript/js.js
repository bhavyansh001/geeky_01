(() => {
  ...
  var Ue = he(() => {
    ...
    window.tram = (function (t) {
      ...
      function b() {}
      function q(e, r) {
        $("Type warning: Expected: [" + e + "] Got: [" + typeof r + "] " + r);
      }
      function C(e, r, i) {
        $("Units do not match [" + e + "]: " + r + ", " + i);
      }
      function z(e, r, i) {
      ...
      var W = (function (e, r, i) {
          ...
          function x(T, Q) {
            ...
            return (
              (be.constructor = l),
              (l.mixin = function (ae) {
                return (S[e] = l[e] = x(l, ae)[e]), l;
              }),
              (l.open = function (ae) {
                if (
                  ((M = {}),
                  u(ae) ? (M = ae.call(l, be, te, l, T)) : o(ae) && (M = ae),
                  o(M))
                )
                  for (var Fe in M) r.call(M, Fe) && (be[Fe] = M[Fe]);
                return u(be.init) || (be.init = T), l;
              }),
              l.open(Q)
            );
          }
      ...
      if (m.transition) {
        var R = m.timing.dom;
        if (((g.style[R] = X["ease-in-back"][0]), !g.style[R]))
          for (var O in _) X[O][0] = _[O];
      }
      var G = (c.frame = (function () {
        ...
        ye = W(function (e) {
          function r(E, F) {
            ...
            F = F || {};
            var ce = v[U];
            if (!ce) return $("Unsupported property: " + U);
            if (!F.weak || !this.props[U]) {
              var me = ce[0],
                le = this.props[U];
              return (
                le || (le = this.props[U] = new me.Bare()),
                le.init(this.$el, ee, ce, F),
                le
              );
            }
          }
              ...
              if (U == "string" && F) {
                switch (E) {
                  ...
                  case "redraw":
                    ...
                    break;
                  default:
                    r.call(this, E, ee && ee[1]);
                }
                return s.call(this);
              }
              if (U == "function") return void E.call(this, this);
              if (U == "object") {
                var ce = 0;
                be.call(
                  this,
                  E,
                  function (ne, Mt) {
                    ne.span > ce && (ce = ne.span), ne.stop(), ne.animate(Mt);
                  },
                  function (ne) {
                    "wait" in ne && (ce = z(ne.wait, 0));
                  }
                ),
                  te.call(this),
                  ce > 0 &&
                    ...
                    (this.active = !0),
                    F && (this.timer.complete = s));
                var me = this,
                  le = !1,
                  Ne = {};
                G(function () {
                  be.call(me, E, function (ne) {
                    ne.active && ((le = !0), (Ne[ne.name] = ne.nextStyle));
                  }),
                    le && me.$el.css(Ne);
                });
              }
          ...
          function x(E) {
            ...
            typeof E == "string"
              ? ((F = {}), (F[E] = 1))
              : (F = typeof E == "object" && E != null ? E : this.props),
              be.call(this, F, ae),
              te.call(this);
          }
          function T(E) {
            x.call(this, E), be.call(this, E, Fe, qt);
          }
          function Q(E) {
            typeof E != "string" && (E = "block"), (this.el.style.display = E);
          }
          function l() {
          ...
          function te() {
            ...
            for (E in this.props)
              (F = this.props[E]), F.active && ee.push(F.string);
            (ee = ee.join(",")),
              this.style !== ee &&
          ...
          function be(E, F, ee) {
            ...
            for (U in E)
              (me = E[U]),
                U in J
                  ? (ne.transform || (ne.transform = {}),
                    (ne.transform[U] = me))
                  : (L.test(U) && (U = d(U)),
                    U in v ? (ne[U] = me) : (le || (le = {}), (le[U] = me)));
            for (U in ne) {
              if (((me = ne[U]), (ce = this.props[U]), !ce)) {
                if (!Ne) continue;
                ce = r.call(this, U);
              }
              F.call(this, ce, me);
          ...
          function pe(E, F) {
            e[E] = function () {
              return this.children
                ? It.call(this, F, arguments)
                : (this.el && F.apply(this, arguments), this);
            };
          }
          function It(E, F) {
            var ee,
              U = this.children.length;
            for (ee = 0; U > ee; ee++) E.apply(this.children[ee], F);
            return this;
          }
          (e.init = function (E) {
            if (
              ...
              var F = h(this.el, "transition");
              F && !de.test(F) && (this.upstream = F);
            }
            m.backface &&
              Z.hideBackface &&
        ...
        A = W(function (e) {
          ...
          function i(s, x, T) {
            return x !== void 0 && (T = x), s in X ? s : T;
          }
          function o(s) {
            var x = /rgba?\((\d+),\s*(\d+),\s*(\d+)/.exec(s);
            return (x ? D(x[1], x[2], x[3]) : s).replace(
              /#(\w)(\w)(\w)$/,
              "#$1$1$2$2$3$3"
            );
          }
          var u = { duration: 500, ease: "ease", delay: 0 };
          (e.init = function (s, x, T, Q) {
            ...
            T[2] && (l = T[2]),
              ...
              (this.name = l),
              (this.type = T[1]),
              (this.duration = z(x[1], this.duration, u.duration)),
              (this.ease = i(x[2], this.ease, u.ease)),
              (this.delay = z(x[3], this.delay, u.delay)),
            ...
            (e.convert = function (s, x) {
              ...
              switch (x) {
                ...
                case P:
                  ...
                  if (l && x.test(s)) return s;
                  T = "number(px) or string(unit)";
                  break;
                case B:
                  if (Q) return s + this.unit;
                  if (l && x.test(s)) return s;
                  T = "number(px) or string(unit or %)";
                  break;
                case re:
                  if (Q) return s + this.angle;
                  if (l && x.test(s)) return s;
                  T = "number(deg) or string(angle)";
                  break;
                case ue:
                  if (Q || (l && B.test(s))) return s;
                  T = "number(unitless) or string(unit or %)";
              }
              return q(T, s), s;
            }),
            (e.redraw = function () {
          ...
          (e.init = function () {
            ...
            (e.values = function (o) {
              var u,
                s = {};
              return (
                i.call(this, o, function (x, T, Q) {
                  (s[x] = T),
                    this.current[x] === void 0 &&
                      ((u = 0),
                      ~x.indexOf("scale") && (u = 1),
                      (this.current[x] = this.convert(u, Q)));
                }),
                s
              );
            });
        ...
        Ce = W(function (e) {
          ...
          function i() {
            var l,
              ...
              te = T.length;
            if (te)
              for (G(i), S = fe(), l = te; l--; ) (M = T[l]), M && M.render(S);
          }
          function o(l) {
            var S,
              M = t.inArray(l, T);
          ...
          (e.init = function (l) {
            (this.duration = l.duration || 0), (this.delay = l.delay || 0);
            var S = l.ease || x.ease;
            X[S] && (S = X[S][1]),
              typeof S != "function" && (S = x.ease),
              (this.ease = S),
              (this.update = l.update || b),
              (this.complete = l.complete || b),
              (this.context = l.context || this),
              (this.name = l.name);
            var M = l.from,
              te = l.to;
            M === void 0 && (M = x.from),
              te === void 0 && (te = x.to),
              (this.unit = l.unit || ""),
              typeof M == "number" && typeof te == "number"
                ? ((this.begin = M), (this.change = te - M))
                : this.format(te, M),
              (this.value = this.begin + this.unit),
              (this.start = fe()),
              l.autoplay !== !1 && this.play();
          }),
            (e.play = function () {
              this.active ||
            ...
            (e.render = function (l) {
              var S,
                M = l - this.start;
              if (this.delay) {
                if (M <= this.delay) return;
                M -= this.delay;
              }
              if (M < this.duration) {
                var te = this.ease(M, 0, 1, this.duration);
                return (
                  (S = this.startRGB
                    ? s(this.startRGB, this.endRGB, te)
                    : u(this.begin + te * this.change)),
                  (this.value = S + this.unit),
                  void this.update.call(this.context, this.value)
                );
              }
              (S = this.endHex || this.begin + this.change),
                (this.value = S + this.unit),
                this.update.call(this.context, this.value),
                this.complete.call(this.context),
                this.destroy();
            }),
            (e.format = function (l, S) {
              if (((S += ""), (l += ""), l.charAt(0) == "#"))
                return (
                  (this.startRGB = k(S)),
                  (this.endRGB = k(l)),
              ...
              if (!this.unit) {
                var M = S.replace(I, ""),
                  te = l.replace(I, "");
                M !== te && C("tween", S, l), (this.unit = M);
              }
              (S = parseFloat(S)),
                (l = parseFloat(l)),
                (this.begin = this.value = S),
                (this.change = l - S);
            }),
            (e.destroy = function () {
              this.stop(),
      ...
      var n = t.style,
        ...
        v = {
          color: [oe, H],
          background: [oe, H, "background-color"],
          "outline-color": [oe, H],
          "border-color": [oe, H],
          "border-top-color": [oe, H],
          "border-right-color": [oe, H],
          "border-bottom-color": [oe, H],
          "border-left-color": [oe, H],
          "border-width": [A, P],
          "border-top-width": [A, P],
          "border-right-width": [A, P],
          "border-bottom-width": [A, P],
          "border-left-width": [A, P],
          "border-spacing": [A, P],
          "letter-spacing": [A, P],
          margin: [A, P],
          "margin-top": [A, P],
    ...
    je.exports = (function () {
      ...
      var c = {},
        ...
        B =
          ...
          t.forEach =
            function (a, f, w) {
              if (a == null) return a;
              if (j && a.forEach === j) a.forEach(f, w);
              else if (a.length === +a.length) {
                for (var m = 0, R = a.length; m < R; m++)
                  if (f.call(w, a[m], m, a) === c) return;
              } else
                for (var O = t.keys(a), m = 0, R = O.length; m < R; m++)
                  if (f.call(w, a[O[m]], O[m], a) === c) return;
              return a;
            });
      (t.map = t.collect =
        function (a, f, w) {
        ...
        (t.find = t.detect =
          function (a, f, w) {
            ...
            return (
              re(a, function (R, O, G) {
                if (f.call(w, R, O, G)) return (m = R), !0;
              }),
              m
            );
          }),
        ...
        t.any =
          function (a, f, w) {
            ...
            return a == null
              ...
              ? a.some(f, w)
              : (B(a, function (R, O, G) {
                  if (m || (m = f.call(w, R, O, G))) return c;
                }),
                !!m);
          });
      (t.contains = t.include =
        ...
        (t.delay = function (a, f) {
          var w = q.call(arguments, 2);
          return setTimeout(function () {
            return a.apply(null, w);
          }, f);
        }),
        (t.defer = function (a) {
          return t.delay.apply(t, [a, 1].concat(q.call(arguments, 1)));
        }),
          ...
          var m,
            ...
            ye = function () {
              ...
              ie < f
                ...
                : ((m = null), w || ((fe = a.apply(O, R)), (O = R = null)));
            };
          return function () {
            (O = this), (R = arguments), (G = t.now());
            var ie = w && !m;
            return (
              m || (m = setTimeout(ye, f)),
              ie && ((fe = a.apply(O, R)), (O = R = null)),
              fe
            );
          };
        }),
        (t.defaults = function (a) {
          ...
          for (var f = 1, w = arguments.length; f < w; f++) {
            var m = arguments[f];
            for (var R in m) a[R] === void 0 && (a[R] = m[R]);
          }
          return a;
        }),
        (t.keys = function (a) {
      ...
      return (
        (t.template = function (a, f, w) {
          ...
          var m = RegExp(
            ...
            R = 0,
            O = "__p+='";
          a.replace(m, function (ie, A, oe, Te, qe) {
            return (
              (O += a.slice(R, qe).replace(Ae, ve)),
              (R = qe + ie.length),
              A
                ? (O +=
                    `'+
...
`;
          var fe;
          try {
            fe = new Function(f.variable || "obj", "_", O);
          } catch (ie) {
            throw ((ie.source = O), ie);
          }
          var ye = function (ie) {
...
` +
  ...
  var Le = he((jt, at) => {
    ...
    var V = {},
      ...
      xe = _e.isFunction,
      ge = (V._ = et()),
      nt = (V.tram = Ue() && _e.tram),
      He = !1,
      Ge = !1;
    nt.config.hideBackface = !1;
    nt.config.keepInherited = !0;
    V.define = function (t, c, d) {
      Ie[t] && it(Ie[t]);
      var k = (Ie[t] = c(_e, ge, d) || {});
      return rt(k), k;
    };
    ...
    function rt(t) {
      V.env() &&
        (xe(t.design) && we.on("__wf_design", t.design),
        xe(t.preview) && we.on("__wf_preview", t.preview)),
        xe(t.destroy) && we.on("__wf_destroy", t.destroy),
        t.ready && xe(t.ready) && Ft(t);
    }
    function Ft(t) {
      if (He) {
        t.ready();
    ...
    function it(t) {
      xe(t.design) && we.off("__wf_design", t.design),
        xe(t.preview) && we.off("__wf_preview", t.preview),
        xe(t.destroy) && we.off("__wf_destroy", t.destroy),
        t.ready && xe(t.ready) && Nt(t);
    }
    function Nt(t) {
      Me = ge.filter(Me, function (c) {
        return c !== t.ready;
      });
    }
    V.push = function (t) {
    ...
    V.env = function (t) {
      var c = window.__wf_design,
        d = typeof c < "u";
      if (!t) return d;
      if (t === "design") return d && c;
      if (t === "preview") return d && !c;
    ...
    var We = navigator.userAgent.toLowerCase(),
      ot = (V.env.touch =
      ...
      Wt = (V.env.chrome =
        ...
        parseInt(We.match(/chrome\/(\d+)\./)[1], 10)),
      Ht = (V.env.ios = /(ipod|iphone|ipad)/.test(We));
    V.env.safari = /safari/.test(We) && !Wt && !Ht;
    var Ve;
    ot &&
      Dt.on("touchstart mousedown", function (t) {
        Ve = t.target;
      });
    V.validClick = ot
      ? function (t) {
          return t === Ve || _e.contains(t, Ve);
        }
      : function () {
          return !0;
        };
    var st = "resize.webflow orientationchange.webflow load.webflow",
      Bt = "scroll.webflow " + st;
    V.resize = Ze(we, st);
    V.scroll = Ze(we, Bt);
    V.redraw = Ze();
    function Ze(t, c) {
      var d = [],
        k = {};
      return (
        (k.up = ge.throttle(function (D) {
          ge.each(d, function (b) {
            b(D);
          });
        })),
        t && c && t.on(c, k.up),
        (k.on = function (D) {
          typeof D == "function" && (ge.contains(d, D) || d.push(D));
        }),
        (k.off = function (D) {
          if (!arguments.length) {
            d = [];
    ...
    V.location = function (t) {
      window.location = t;
    };
    V.env() && (V.location = function () {});
    V.ready = function () {
      (He = !0), Ge ? $t() : ge.each(Me, tt), ge.each(Ye, tt), V.resize.up();
    };
    function tt(t) {
      xe(t) && t();
    }
    ...
    function ut() {
      Se && (Se.reject(), we.off("load", Se.resolve)),
        (Se = new _e.Deferred()),
        we.on("load", Se.resolve);
    }
    ...
    ct.define(
      ...
      (ft.exports = function (t) {
        var c = {},
          ...
          $;
        c.ready = function () {
          var _ = k.attr("data-wf-status"),
            Y = k.attr("data-wf-domain") || "";
          /\.webflow\.io$/i.test(Y) && q.hostname !== Y && (_ = !0),
            _ &&
              !C &&
              (($ = $ || W()),
              X(),
        ...
        function j() {
          ...
          t($).attr("style", _ ? "display: none !important;" : "");
        }
        function W() {
        ...
        function t(d) {
          ...
          function z(p) {
            var H = p.type,
              P = p.tagName;
            return !!(
              (P === "INPUT" && q[H] && !p.readOnly) ||
              (P === "TEXTAREA" && !p.readOnly) ||
              p.isContentEditable
            );
          }
          function $(p) {
          ...
          function W(p) {
            p.metaKey ||
              p.altKey ||
              p.ctrlKey ||
              (C(d.activeElement) && $(d.activeElement), (k = !0));
          }
          function X() {
            k = !1;
          }
          function _(p) {
            C(p.target) && (k || z(p.target)) && $(p.target);
          }
          function Y(p) {
            C(p.target) &&
          ...
          function K() {
            document.visibilityState === "hidden" && (D && (k = !0), N());
          }
          function N() {
          ...
          document.addEventListener("keydown", W, !0),
            ...
            N(),
            d.addEventListener("focus", _, !0),
            d.addEventListener("blur", Y, !0);
        }
        function c() {
      ...
      (pt.exports = function () {
        ...
        function k(q) {
          var C = q.target,
            z = C.tagName;
          return (
            (/^a$/i.test(z) && C.href != null) ||
            (/^(button|textarea)$/i.test(z) && C.disabled !== !0) ||
            (/^input$/i.test(z) &&
              /^(button|reset|submit|radio|checkbox)$/i.test(C.type) &&
              !C.disabled) ||
            (!/^(button|input|textarea|select|a)$/i.test(z) &&
              !Number.isNaN(Number.parseFloat(C.tabIndex))) ||
            /^audio$/i.test(z) ||
            (/^video$/i.test(z) && C.controls === !0)
          );
        }
        function D(q) {
          k(q) &&
            ((c = !0),
            setTimeout(() => {
              for (c = !1, q.target.focus(); t.length > 0; ) {
                var C = t.pop();
    ...
    ze.define(
      ...
      (gt.exports = function (t, c) {
        var d = {},
          ...
          W,
          X;
        d.ready = d.design = d.preview = _;
        function _() {
          (D = b && ze.env("design")),
            (X = ze.env("slug") || q.pathname || ""),
            ze.scroll.off(K),
            (W = []);
          for (var I = document.links, L = 0; L < I.length; ++L) Y(I[L]);
          W.length && (ze.scroll.on(K), K());
        }
        function Y(I) {
          if (!I.getAttribute("hreflang")) {
            var L =
              (D && I.getAttribute("href-disabled")) || I.getAttribute("href");
            if (((C.href = L), !(L.indexOf(":") >= 0))) {
              var p = t(I);
              if (
                C.hash.length > 1 &&
                C.host + C.pathname === q.host + q.pathname
              ) {
                if (!/^#[a-zA-Z0-9\-\_]+$/.test(C.hash)) return;
                var H = t(C.hash);
                H.length && W.push({ link: p, sec: H, active: !1 });
                return;
              }
              if (!(L === "#" || L === "")) {
                var P =
                  C.href === q.href || L === X || ($.test(L) && j.test(X));
                N(p, z, P);
              }
            }
          }
          ...
          c.each(W, function (p) {
            if (!p.link.attr("hreflang")) {
              var H = p.link,
                ...
                re = P.outerHeight(),
                ue = L * 0.5,
                de = P.is(":visible") && B + re - ue >= I && B + ue <= I + L;
              p.active !== de && ((p.active = de), N(H, z, de));
            }
          });
        }
        function N(I, L, p) {
          var H = I.hasClass(L);
          (p && H) || (!p && !H) || (p ? I.addClass(L) : I.removeClass(L));
        }
        return d;
      })
    );
    ...
    Be.define(
      ...
      (yt.exports = function (t) {
        var c = {
          ...
          z = Be.env("editor") ? ".w-editor-body" : "body",
          $ =
            "header, " +
            z +
            " > .header, " +
        ...
        var K = /^#[a-zA-Z0-9][\w:.-]*$/;
        function N(g) {
          return K.test(g.hash) && g.host + g.pathname === d.host + d.pathname;
        }
        let I =
        ...
        function B(g, a) {
          ...
          if (f !== w) {
            var m = ue(g, f, w),
              ...
              O = function () {
                var G = Date.now() - R;
                window.scroll(0, de(f, w, G, m)),
                  G <= m ? C(O) : typeof a == "function" && a();
              };
            C(O);
          }
        }
        ...
        function ue(g, a, f) {
          ...
          var w = 1;
          return (
            q.add(g).each(function (m, R) {
              var O = parseFloat(R.getAttribute("data-scroll-time"));
              !isNaN(O) && O >= 0 && (w = O);
            }),
    ...
    Kt.define(
      ...
      (xt.exports = function (t) {
        ...
        (t.event.special.tap = { bindType: "click", delegateType: "click" }),
          (c.init = function (b) {
            return (
              (b = typeof b == "string" ? t(b).get(0) : b), b ? new k(b) : null
            );
          });
        function k(b) {
          var q = !1,
            C = !1,
            z = Math.min(Math.round(window.innerWidth * 0.04), 40),
            $,
            j;
          b.addEventListener("touchstart", W, !1),
            b.addEventListener("touchmove", X, !1),
            b.addEventListener("touchend", _, !1),
            b.addEventListener("touchcancel", Y, !1),
            b.addEventListener("mousedown", W, !1),
            b.addEventListener("mousemove", X, !1),
            b.addEventListener("mouseup", _, !1),
            b.addEventListener("mouseout", Y, !1);
          function W(N) {
            var I = N.touches;
            (I && I.length > 1) ||
              ((q = !0),
              I ? ((C = !0), ($ = I[0].clientX)) : ($ = N.clientX),
              (j = $));
          }
          function X(N) {
            if (q) {
              if (C && N.type === "mousemove") {
                N.preventDefault(), N.stopPropagation();
                return;
              }
              var I = N.touches,
                L = I ? I[0].clientX : N.clientX,
                p = L - j;
              (j = L),
                Math.abs(p) > z &&
                  d &&
                  String(d()) === "" &&
                  (D("swipe", N, { direction: p > 0 ? "right" : "left" }), Y());
            }
          }
          function _(N) {
            if (q && ((q = !1), C && N.type === "mouseup")) {
              N.preventDefault(), N.stopPropagation(), (C = !1);
              return;
            }
          }
          function Y() {
          ...
          function K() {
            b.removeEventListener("touchstart", W, !1),
              b.removeEventListener("touchmove", X, !1),
              b.removeEventListener("touchend", _, !1),
              b.removeEventListener("touchcancel", Y, !1),
              b.removeEventListener("mousedown", W, !1),
              b.removeEventListener("mousemove", X, !1),
              b.removeEventListener("mouseup", _, !1),
              b.removeEventListener("mouseout", Y, !1),
              (b = null);
          }
          this.destroy = K;
        }
        function D(b, q, C) {
          var z = t.Event(b, { originalEvent: q });
          t(q.target).trigger(z, C);
        }
  ...
  var Lt = he((un, _t) => {
    ...
    var Qe = window.jQuery,
      ...
      Xe = {
        ...
        intro: function (t, c) {
          c.__wf_intro ||
            ((c.__wf_intro = !0), Qe(c).triggerHandler(Ee.types.INTRO));
        },
        outro: function (t, c) {
          c.__wf_intro &&
            ((c.__wf_intro = null), Qe(c).triggerHandler(Ee.types.OUTRO));
        },
      };
    Ee.triggers = {};
    Ee.types = { INTRO: "w-ix-intro" + kt, OUTRO: "w-ix-outro" + kt };
    Ee.init = function () {
      for (var t = $e.length, c = 0; c < t; c++) {
        var d = $e[c];
        d[0](0, d[1]);
      }
      ($e = []), Qe.extend(Ee.triggers, Xe);
    };
    Ee.async = function () {
      for (var t in Xe) {
        var c = Xe[t];
        Xe.hasOwnProperty(t) &&
          (Ee.triggers[t] = function (d, k) {
            $e.push([c, k]);
          });
      }
    };
  ...
  var Ct = he((an, Tt) => {
    ...
    function Ot(t, c) {
      ...
      d.initCustomEvent(c, !0, !0, null), t.dispatchEvent(d);
    }
    var Ut = window.jQuery,
      ...
      Vt = {
        ...
        intro: function (t, c) {
          Je.triggers.intro(t, c), Ot(c, "COMPONENT_ACTIVE");
        },
        outro: function (t, c) {
          Je.triggers.outro(t, c), Ot(c, "COMPONENT_INACTIVE");
        },
      };
    Ke.triggers = {};
    Ke.types = { INTRO: "w-ix-intro" + At, OUTRO: "w-ix-outro" + At };
    Ut.extend(Ke.triggers, Vt);
    Tt.exports = Ke;
  });
  var St = he((cn, Rt) => {
    "use strict";
    ...
    Oe.define(
      ...
      (Rt.exports = function (t, c) {
        var d = {},
          ...
          p = Yt.triggers,
          H = t();
        (d.ready = d.design = d.preview = P),
          (d.destroy = function () {
            (H = t()), B(), z && z.length && z.each(Ae);
          });
        function P() {
          ($ = W && Oe.env("design")),
            (j = Oe.env("editor")),
        ...
        function de(n, h) {
          ...
          J &&
            ...
            a(v),
            $
              ? (ve(v), v.el.on("setting" + _, f(v)))
              : (g(v),
                v.button.on("click" + _, G(v)),
                v.menu.on("click" + _, "a", fe(v)),
                v.button.on("keydown" + _, w(v)),
                v.el.on("keydown" + _, m(v))),
            A(n, h);
        }
        function Ae(n, h) {
          var y = t.data(h, _);
          y && (ve(y), t.removeData(h, _));
        }
        function ve(n) {
        ...
        function a(n) {
          var h = {},
            y = n.config || {},
            v = (h.animation = n.el.attr("data-animation") || "default");
          (h.animOver = /^over/.test(v)),
            (h.animDirect = /left$/.test(v) ? -1 : 1),
            y.animation !== v && n.open && c.defer(O, n),
        ...
        function w(n) {
          return function (h) {
            switch (h.keyCode) {
              ...
              case se.ESCAPE:
                return Z(n), h.preventDefault(), h.stopPropagation();
              case se.ARROW_RIGHT:
              case se.ARROW_DOWN:
              case se.HOME:
              case se.END:
        ...
        function fe(n) {
          return function (h) {
            ...
            v && v.indexOf("#") === 0 && n.open && Z(n);
          };
        }
        function ye(n) {
          return (
            n.outside && b.off("click" + _, n.outside),
            function (h) {
              var y = t(h.target);
              (j && y.closest(".w-editor-bem-EditorOverlay").length) ||
                ie(n, y);
            }
          );
        }
        var ie = q(function (n, h) {
          if (n.open) {
        ...
        function A(n, h) {
          ...
          if ((y.open && !v && !$ && Z(y, !0), y.container.length)) {
            var J = Te(y);
            y.links.each(J), y.dropdowns.each(J);
          }
          y.open && Pe(y);
        }
        var oe = "max-width";
        function Te(n) {
          ...
          return (
            h === "none" && (h = ""),
            function (y, v) {
              (v = t(v)), v.css(oe, ""), v.css(oe) === "none" && v.css(oe, h);
            }
          );
        }
        function qe(n, h) {
        ...
        function ke(n, h) {
          ...
          (n.open = !0),
            n.menu.each(qe),
            n.links.addClass(L),
            n.dropdowns.addClass(K),
            n.dropdownToggle.addClass(N),
            n.dropdownList.addClass(I),
            n.button.addClass(Y);
          var y = n.config,
            v = y.animation;
          (v === "none" || !k.support.transform || y.duration <= 0) && (h = !0);
          var J = Pe(n),
          ...
          if (
            (n.overlay &&
              ((H = n.menu.prev()), n.overlay.show().append(n.menu)),
            y.animOver)
          ) {
            k(n.menu)
              .add(i)
              .set({ x: y.animDirect * Re, height: J })
              .start({ x: 0 })
              .then(u),
        ...
        function Pe(n) {
          var h = n.config,
            y = h.docHeight ? b.height() : C.height();
          return (
            h.animOver
              ? n.menu.height(y)
              : n.el.css("position") !== "fixed" && (y -= n.el.outerHeight(!0)),
            n.overlay && n.overlay.height(y),
            y
          );
        }
        function Z(n, h) {
          if (!n.open) return;
          (n.open = !1), n.button.removeClass(Y);
          var y = n.config;
          if (
            ((y.animation === "none" ||
              !k.support.transform ||
          ...
          var e = Re + J;
          k(n.menu).add(v).start({ y: -e }).then(r);
          function r() {
            n.menu.height(""),
              k(n.menu).set({ x: 0, y: 0 }),
              n.menu.each(Ce),
              n.links.removeClass(L),
              n.dropdowns.removeClass(K),
              n.dropdownToggle.removeClass(N),
              n.dropdownList.removeClass(I),
              n.overlay &&
                n.overlay.children().length &&
                (H.length ? n.menu.insertAfter(H) : n.menu.prependTo(n.parent),
